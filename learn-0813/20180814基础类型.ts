...
let namm: string = "Bob";
let age: number = 12;
let persionMessage = `${namm} 的年级是 ${age}`
...
enum Color { red = 10, blue, yellow, green = 'green' };

let enumRed: Color = Color.red;
let enumBlue: Color = Color.blue;
let enumGreen: Color = Color.green;
...
let anyArr: any[] = [1, true, false, '213', {}];
